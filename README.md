...
<ul>
  <li>
  <strong>Standard</strong>: Nerd Font icons (e.g., <img src="./assets/staged.svg" alt="staged"> for staged, <img src="./assets/modified.svg" alt="modified"> for modified, <img src="./assets/ahead.svg" alt="ahead"> for ahead).
  </li>
  <li>
